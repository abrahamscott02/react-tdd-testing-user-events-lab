...
test("the page shows information the user types into the name and email address form fields", () => {
  ...
  userEvent.type(fullName, "Abraham Scott");
  userEvent.type(emailAddress, "abraham@gmail.com");

  expect(fullName).toHaveValue("Abraham Scott");
  expect(emailAddress).toHaveValue("abraham@gmail.com");
});
...
test("a message is displayed when the user clicks the Submit button", () => {
  ...
  userEvent.type(screen.getByLabelText(/enter your name/i), "Abraham Scott");
  userEvent.type(
    screen.getByLabelText(/enter your email address/i),
    "abraham@gmail.com"
  );
  ...
  expect(
    screen.getByText(
      "Thanks Abraham Scott! You are signed up for these newsletters:"
    )
  ).toBeInTheDocument();
